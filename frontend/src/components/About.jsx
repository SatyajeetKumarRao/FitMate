      ...
      <Stack ml={"100px"} mr={'100px'} p={2}>
          ...
          <Grid templateColumns="repeat(3, 1fr)" gap={4} textAlign={'center'}>
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-1.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
            ...
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-2.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
            ...
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-3.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
            ...
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-4.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
            ...
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-5.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
            ...
            <Box borderWidth="0" maxW={'sm'} m="2"  justify={'center'}>
              <Image src={'./image-6.avif'} alt="image-1" boxSize={'200px'} ml={'70px'} />
